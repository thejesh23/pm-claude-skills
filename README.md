# 🧠 PM Skills — 330 Professional Agent Skills for Claude, ChatGPT, Gemini, Cursor, Codex & Hermes
...
[![Skills](https://img.shields.io/badge/skills-330-blue)](https://github.com/mohitagw15856/pm-claude-skills)
...
<p align="center">
  <a href="https://mohitagw15856.github.io/pm-claude-skills/">
    <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=24&pause=900&color=D97757&center=true&vCenter=true&width=720&lines=330+pro+AI+skills;PRDs%2C+roadmaps%2C+launches+%E2%80%94+done+right;Run+any+one+free+in+your+browser" alt="PM Skills" />
  </a>
</p>
...
> 330 professional skills + 4 agent templates across 47 bundles covering 23 professions. Built for Claude Code — and now portable to ChatGPT, Gemini, and Hermes Agent. Built by a PM, used by everyone.

A community-built library of professional skills for every field — product management, engineering, customer success, marketing, social media, writers, design, legal, finance, HR, sales, operations, research, and more. Each skill is a structured `SKILL.md` file that teaches an AI assistant how to produce professional-grade outputs for your workflows. Skills run natively in **Claude Code** and **Hermes Agent** (same open `SKILL.md` standard), and ship as ready-to-paste exports for **ChatGPT** and **Gemini** — see [Works With](#-works-with--cross-tool-compatibility).

**🆕 Latest — v31.1.0 (Charts, Present mode & live diagram samples):** three more ways your output comes alive in the playground. **📊 Charts** — a new `chart` skill (and any skill) can emit a ` ```chart ` block that renders as a live **bar / line / pie** chart, exportable as PNG. **▶ Present** — turn any result into a fullscreen, arrow-key **slideshow** in one click. And the `pm-visuals` diagram skills now ship **pre-generated samples**, so a rendered flowchart, architecture diagram, Gantt chart, and chart show up instantly — no key, no run. *Earlier (v31.0):* the **🎨 `pm-visuals` bundle** (live Mermaid diagrams → PNG/SVG) and **📅 Calendar (.ics) export**. **330 skills across 47 bundles.** → **[Full release history & notes](https://github.com/mohitagw15856/pm-claude-skills/releases)**.
...
The whole library on one page — install, all 330 skills by profession, the Professional Brain, the REST API, integrations, and quality tooling. Great to **print, share, or drop into a slide**.

<p align="center">
  <a href="CHEATSHEET.md">
    <img src="web/docs-assets/cheatsheet.png" width="80%" alt="PM Skills one-page cheatsheet — 330 skills, the Professional Brain, REST API, integrations, and tooling at a glance." />
  </a>
</p>
...
These 330 skills aren't a random catalog — they cover the **full arc of professional work**, end to end. Wherever you are in the loop, there's a skill for it:
...
> New here? Start with the [**top-tier skills**](#️-skill-tiers--start-with-the-strongest), or jump straight to [**all 330 skills**](#️-all-330-skills) grouped by profession.
...
|---|:---:|:---:|
| Skills | **330**, across 23 professions | a handful → dozens, usually one domain |
...
**With the [`skills`](https://github.com/vercel-labs/skills) CLI** (the open agent-skills installer that works across Claude Code, Cursor, Codex, OpenCode & 60+ agents) — pick from all 330 interactively:
...
npx skills add mohitagw15856/pm-claude-skills --skill '*'            # install all 330
```
...
**Or one-line MCP** — make all 330 skills + 5 workflow recipes available in *every* session of any MCP client (Claude Code, Claude Desktop, Cursor, Windsurf), no per-file install:
...
The same 330 skills reach you through every channel — pick whatever fits your stack:
...
> **208 of 330 skills are eval-scored, averaging 4.8/5** — see the [leaderboard](https://mohitagw15856.github.io/pm-claude-skills/leaderboard.html).
...
**In your editor (VS Code / Cursor):** the [**`vscode-extension/`**](vscode-extension/) brings all 330 skills into the Command Palette — search and *insert a skill as context* for Copilot/Cursor chat, copy it, or open it in the Playground.
...
This library is the largest open-source collection of professional skills available — covering 20 professions beyond financial services. **The 330 skills here are the building blocks for agent templates outside of finance.**
...
**Latest: v30.0.0 — 25 new skills, 4 new bundles (AI-builder, crisis comms, healthcare, life-admin, nonprofit) & an eval-coverage page.** 330 skills across 47 bundles, 23 professions. Every tagged release has complete notes on the **[Releases page](https://github.com/mohitagw15856/pm-claude-skills/releases)**.
...
A 330-skill library doesn't have 330 equally-mature skills, and pretending otherwise
...
Building and maintaining 330 skills across 47 bundles takes real time — testing skills against new model releases, building new ones from community requests, writing the article series, and keeping documentation current.
...
eval-scored or security-audited** (that's the [curated library](#️-all-330-skills) above). Want
