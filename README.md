# 🧠 PM Skills — 366 Professional Agent Skills for Claude, ChatGPT, Gemini, Cursor, Codex & Hermes
...
[![Skills](https://img.shields.io/badge/skills-366-blue)](https://github.com/mohitagw15856/pm-claude-skills)
...
<p align="center">
  <a href="https://mohitagw15856.github.io/pm-claude-skills/">
    <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=24&pause=900&color=D97757&center=true&vCenter=true&width=720&lines=366+pro+AI+skills;PRDs%2C+roadmaps%2C+launches+%E2%80%94+done+right;Run+any+one+free+in+your+browser" alt="PM Skills" />
  </a>
</p>
...
The whole library on one page — install, all 366 skills by profession, the Professional Brain, the REST API, integrations, and quality tooling. Great to **print, share, or drop into a slide**.

<p align="center">
  <a href="CHEATSHEET.md">
    <img src="web/docs-assets/cheatsheet.png" width="80%" alt="PM Skills one-page cheatsheet — 366 skills, the Professional Brain, REST API, integrations, and tooling at a glance." />
  </a>
</p>
...
These 366 skills aren't a random catalog — they cover the **full arc of professional work**, end to end. Wherever you are in the loop, there's a skill for it:
...
> New here? Start with the [**top-tier skills**](#️-skill-tiers--start-with-the-strongest), or jump straight to [**all 366 skills**](#️-all-366-skills) grouped by profession.
...
|---|:---:|:---:|
| Skills | **366**, across 23 professions | a handful → dozens, usually one domain |
...
**With the [`skills`](https://github.com/vercel-labs/skills) CLI** (the open agent-skills installer that works across Claude Code, Cursor, Codex, OpenCode & 60+ agents) — pick from all 366 interactively:
...
npx skills add mohitagw15856/pm-claude-skills --skill '*'            # install all 366
```
...
**Or one-line MCP** — make all 366 skills + 5 workflow recipes available in *every* session of any MCP client (Claude Code, Claude Desktop, Cursor, Windsurf), no per-file install:
...
The same 366 skills reach you through every channel — pick whatever fits your stack:
...
> **208 of 366 skills are eval-scored, averaging 4.8/5** — see the [leaderboard](https://mohitagw15856.github.io/pm-claude-skills/leaderboard.html).
...
**In your editor (VS Code / Cursor):** the [**`vscode-extension/`**](vscode-extension/) brings all 366 skills into the Command Palette — search and *insert a skill as context* for Copilot/Cursor chat, copy it, or open it in the Playground.
...
This library is the largest open-source collection of professional skills available — covering 20 professions beyond financial services. **The 366 skills here are the building blocks for agent templates outside of finance.**
...
**Latest: v32.0.0 — 4 new bundles, 24 skills (E-commerce, UX Writing, Recruiting, Accounting).** 366 skills across 53 bundles, 23 professions. Every tagged release has complete notes on the **[Releases page](https://github.com/mohitagw15856/pm-claude-skills/releases)**.
...
A 366-skill library doesn't have 366 equally-mature skills, and pretending otherwise
...
Building and maintaining 366 skills across 53 bundles takes real time — testing skills against new model releases, building new ones from community requests, writing the article series, and keeping documentation current.
...
eval-scored or security-audited** (that's the [curated library](#️-all-366-skills) above). Want
